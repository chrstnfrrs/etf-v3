  ...
  of: [
    {
      ...
      styles: [
        ...
        {
          blockEditor: { render: AB1 },
          title: 'Body 1',
          value: 'body-1',
        },
        {
          blockEditor: { render: AB2 },
          title: 'Body 2',
          value: 'body-2',
        },
        {
          blockEditor: { render: AH1 },
          title: 'Heading 1',
          value: 'h1',
        },
        {
          blockEditor: { render: AH2 },
          title: 'Heading 2',
          value: 'h2',
        },
        {
          blockEditor: { render: AH3 },
          title: 'Heading 3',
          value: 'h3',
        },
        {
          blockEditor: { render: AH4 },
          title: 'Heading 4',
          value: 'h4',
        },
        {
          blockEditor: { render: AH5 },
          title: 'Heading 5',
          value: 'h5',
        },
        {
          blockEditor: { render: AH6 },
          title: 'Heading 6',
          value: 'h6',
        },
      ],
